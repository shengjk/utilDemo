...
public class KafkaOffsetTool {
    ...
    private Map<TopicAndPartition, BrokerEndPoint> findLeader(String brokerList, List<String> topics) {
        // get broker's url array  [kafka02-dev.bi-report.v5q.cn,kafka02-dev.bi-report.v5q.cn]
        String[] brokerUrlArray = getBorkerUrlFromBrokerList(brokerList);
        // get broker's port map (kafka02-dev.bi-report.v5q.cn -> 9092,kafka02-dev.bi-report.v5q.cn -> 9092)
	...
	/**
	 *kafka02-dev.bi-report.v5q.cn:9092,kafka02-dev.bi-report.v5q.cn:9092
	 * @param brokerlist
	 * @return
	 */
