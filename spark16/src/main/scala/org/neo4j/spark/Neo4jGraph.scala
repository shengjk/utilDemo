...
object Neo4jGraph {
  ...
  //change graphx' nodeProp and relProp
      ...
      case _ =>
        ...
        graph.vertices.repartition(batchSize).mapPartitions[Long](
          p => {
            ...
            //(4,0.15),(8,1.5685514531249993),(10,0.15),(2,0.38587499999999997)
            val rows = p.map(v => Seq(("id", v._1), ("value", v._2)).toMap.asJava).toList.asJava
           val a=rows.get(0)
            
            println("updateNodes " + updateNodes)
