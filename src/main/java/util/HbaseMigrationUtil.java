 ...
 */
public class HbaseMigrationUtil {
    private static Logger logger = Logger.getLogger(SendMail.class);
    public static void hbaseMigration(String username,String password,String hostName,int port,String[] command ){
