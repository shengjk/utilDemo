...
/**
 * Created by shengjk1 on 2017/8/16 0016
 */
public class SysGetProperty {
	public static void main(String[] args) {
		...
		System.out.println("Java 虚拟机实现供应商：" + System.getProperty("java.vm.vendor")); // Java虚拟机提供商
		System.out.println("Java虚拟机名称：" + System.getProperty("java.vm.name")); // Java虚拟机名称
		System.out.println("Java 运行时环境规范版本：" + System.getProperty("java.specification.version")); // Java规范版本号
		System.out.println("Java 运行时环境规范供应商：" + System.getProperty("java.specification.vendor")); // Java规范提供商
		System.out.println("Java 运行时环境规范名称：" + System.getProperty("java.specification.name")); // Java规范名称
		...
		System.out.println("要使用的 JIT 编译器的名称：" + System.getProperty("java.compiler")); // Java编译器
		...
		System.out.println("换行分隔符：" + System.getProperty("line.separator")); // 直线分隔符
		System.out.println("用户的账户名称：" + System.getProperty("user.name")); // 用户名
		System.out.println("用户的主目录：" + System.getProperty("user.home")); // 用户的主目录
		System.out.println("用户的当前工作目录：" + System.getProperty("user.dir")); // 当前程序所在目录
	}
}
